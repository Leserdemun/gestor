        ...
        <div class="w-full max-w-md glass-card p-10 rounded-2xl relative overflow-hidden">
            ...
            <form id="loginForm" class="space-y-5">
                ...
                <div class="space-y-1.5">
                    <label for="usuario" class="text-xs font-bold text-slate-400 ml-1 uppercase tracking-wider">
                        ID Usuario
                    </label>
                    <div class="relative group">
                        ...
                        <input type="text" id="usuario"
                            class="block w-full pl-11 pr-4 py-3 bg-slate-950/50 border border-slate-700/50 rounded-xl text-slate-200 placeholder-slate-600 
                   focus:outline-none focus:ring-1 focus:ring-ink-cyan focus:border-ink-cyan transition-all shadow-inner" placeholder="usuario">
                    </div>
                </div>
